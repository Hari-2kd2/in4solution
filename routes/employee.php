...
Route::group(['middleware' => ['preventbackbutton', 'auth']], function () {
    ...
    Route::group(['prefix' => 'employee'], function () {
        ...
        Route::get('/salary-revision-remove', ['as' => 'employee.salaryRevisionRemoe', 'uses' => 'Employee\EmployeeController@salaryRevisionRemoe']);
    });
    ...
    Route::get('getdesignation', 'Employee\EmployeeController@getDesignation')->name('employee.getdesignation');
    Route::get('getdepartment', 'Employee\EmployeeController@getDepartment')->name('employee.getdepartment');
    Route::get('workshift', 'Employee\EmployeeController@getShift')->name('employee.workshift');
    Route::get('supervisor', 'Employee\EmployeeController@getSupervisor')->name('employee.supervisor');
    Route::get('functionalhead', 'Employee\EmployeeController@getFunctionalHead')->name('employee.functionalhead');
