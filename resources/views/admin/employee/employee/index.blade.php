                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        @if (session('logged_session_data.role_id') == 1)
                            <div class="border" style="border: 1px solid #EFEEEF;border-radius:4px;padding:12px">
                                ...
                                <div class="row hidden-xs hidden-sm">
                                    ...
                                    <form action="{{ route('employee.import') }}" method="post"
                                        ...
                                        <div class="row">
                                            <div>
                                                <div class="col-md-3 text-right" style="margin-left:14px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" hidden>
                                <div class="form-group">
                                    <label for="exampleInput">@lang('employee.user_role')</label>
                                    <select name="role_id" class="form-control role_id select2" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-right" style="padding:0 0 12px 0;">
                                    @if (count($results) > 1)
                                        <a
                                            href="{{ route('employee.export', ['branch_id' => request()->get('branch_id')]) }}">
...
<script>
    $(function() {
        ...
        $(".department_id,.designation_id,.role_id,.branch_id ").change(function() {
            getData(1);
        });
        ...
        function getData(page) {
            ...
            $.ajax({
                url: '?page=' + page + "&department_id=" + department_id + "&designation_id=" +
                    designation_id + "&role_id=" + role_id + "&employee_name=" + employee_name +
                    "&branch_id=" + branch_id,
                datatype: "html",
            }).done(function(data) {
                $('.data').html(data);
        ...
        $('#branch_id, #status').change(function(e) {
            e.preventDefault();
            location.href = '{{ Route('employee.index') }}' + '?branch_id=' + $('#branch_id').val() +
                '&status=' + $('#status').val();
