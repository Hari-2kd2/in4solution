                                    ...
                                    <div id="custom-search-input">
                                        <div class="input-group col-md-12">
                                            <input type="text" class="search-query form-control employee_name"
                                                value="{{isset($_GET['name']) ?  $_GET['name'] : '' }}" placeholder=" @lang('employee.search_by_employee_name')" />
                                    ...
                                    <select name="department_id" class="form-control department_id  select2" required>
                                        ...
                                        @foreach ($departmentList as $value)
                                            <option value="{{ $value->department_id }}"
                                                @if ($value->department_id == old('department_id')) {{ 'selected' }} @elseif(isset($_GET['department_id']) && $value->department_id == $_GET['department_id']) {{ 'selected' }} @endif>
                                    ...
                                    <select name="designation_id" class="form-control designation_id select2" required>
                                        ...
                                        @foreach ($designationList as $value)
                                            <option value="{{ $value->designation_id }}"
                                                @if ($value->designation_id == old('designation_id')) {{ 'selected' }} @elseif(isset($_GET['designation_id']) && $value->designation_id == $_GET['designation_id']) {{ 'selected' }} @endif>
                                    ...
                                    <select name="role_id" class="form-control role_id select2" required>
                                        ...
                                        @foreach ($roleList as $value)
                                            <option value="{{ $value->role_id }}"
                                                @if ($value->role_id == old('role_id')) {{ 'selected' }}  @elseif(isset($_GET['role_id']) && $value->role_id == $_GET['role_id']) {{ 'selected' }} @endif>
