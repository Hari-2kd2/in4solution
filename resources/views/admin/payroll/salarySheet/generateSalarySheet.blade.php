        ...
        <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="bg-title border" style="margin: 12px;padding:12px">
                            ...
                            <div style="margin-left:6px;">
                                ...
                                {{ Form::close() }}
                                <label for="exampleInput" class="col-md-offset-2"
                                    style="padding-top:12px;padding-bottom:12px;display:none">Make payment to all
                                    employee :</label>
            ...
            @if (isset($employeeDetails) || isset($allowances))
                ...
                @php
                    ...
                    $gross_salary = $employeeDetails->salary_gross;
                    $basic_salary = $employeeDetails->salary_ctc;
                    $total_allowances = 0;
                    if (isset($allowances['allowanceArray']) && count($allowances['allowanceArray']) > 0) {
                                ...
                                <div class="col-md-6">
                                    <table class="table table-bordered table-hover table-striped">
                                        <tbody>
                                            ...
                                            @if (isset($deductions['deductionArray']) && count($deductions['deductionArray']) > 0)
                                            ...
                                            @if (isset($advanceDeduction['deductionArray']) && count($advanceDeduction['deductionArray']) > 0)
                                            ...
                                            @if (isset($monthlyDeduction['monthlyDeductionArray']) && count($monthlyDeduction['monthlyDeductionArray']) > 0)
