                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            @endif --}}
                                            <p>@lang('employee.name'):<b>{{ $leaveApplicationData->employee->first_name }}
                                                    {{ $leaveApplicationData->employee->last_name ?? '' }}</b></p>
                                ...
                                @if ($leaveApplicationData->leave_type_id == 5 || $leaveApplicationData->leave_type_id == 6)
                                    <div class="form-group">
                                        <label class="col-md-6 col-sm-6">@lang('employee.no_of_child') :</label>
                                        <p class="col-md-6 col-sm-6">
                                            {{ $leaveApplicationData->employee->no_of_child ?? '-' }}
                                        </p>
                                    </div>
                                @endif
                            </div>
