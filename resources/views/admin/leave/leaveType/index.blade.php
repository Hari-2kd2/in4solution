                                    ...
                                    @foreach ($results as $value)
                                        <tr class="{!! $value->leave_type_id !!}">
                                            ...
                                            {{-- <td style="width: 100px;">
												...
												<a href="{!!route('leaveType.delete',$value->leave_type_id  )!!}" data-token="{!! csrf_token() !!}" data-id="{!! $value->leave_type_id !!}" class="delete btn btn-danger btn-xs deleteBtn btnColor"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            </td> --}}
                                        </tr>
                                    @endforeach
                                </tbody>
