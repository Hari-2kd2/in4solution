                        ...
                        <div class="">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div id="resume">
                                    ...
                                    <p><b>@lang('employee.name') :
                                        </b><strong>{{ $employeeInfo->first_name }}{{ ' ' }}{{ $employeeInfo->last_name }}</strong>
                                    </p>
                                    ...
                                    @endif
                                    <p> <b>@lang('employee.supervisor') :</b> {!! $employeeInfo->supervisorDetail() !!}</p>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                ...
                                                <div class="box-body">
                                                    <table id="example1" class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>6</td>
                                                                <td>{{ $employeeInfo->document_title6 ?? '-' }}</td>
                                                                <td>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="{{ route('profile.accept', $employeeInfo->employee_id) }}">
                                            <button type="button" class="col-md-2 btn btn-success btn_style"
                                                style="margin: 0 12px;"><i class="fa fa-check"></i>
                                                @lang('common.approve')</button>
                                        </a>
                                        <a href="{{ route('profile.reject', $employeeInfo->employee_id) }}">
                                            <button type="button" class="col-md-2 btn btn-danger btn_style"
                                                style="margin: 0 12px;"><i class="fa fa-close"></i>
                                                @lang('common.reject')</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
