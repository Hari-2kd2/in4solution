					...
					<div class="panel-body">
						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group">
										<label class="control-label col-md-4">@lang('passwords.current_password')<span class="validateRq">*</span></label>
										<div class="col-md-8">
											{!! Form::password('oldPassword', $attributes = array('class'=>'form-control required oldPassword','id'=>'oldPassword','placeholder'=>__('passwords.current_password'))) !!}
										</div>
									</div>
								</div>
							</div>
