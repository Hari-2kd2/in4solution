                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    @if (isset($value['face_id_in']) && $value['face_id_in'] != '')
                                                        <a href="{{ asset('storage/app/public/faceId/' . $value['face_id_in']) }}"
                                                            target="_blank">
                                                            <img id="face_image"
                                                                src="{{ asset('storage/app/public/faceId/' . $value['face_id_in']) }}"
                                                    ...
                                                    @if (isset($value['face_id_out']) && $value['face_id_out'] != '')
                                                        <a href="{{ asset('storage/app/public/faceId/' . $value['face_id_out']) }}"
                                                            target="_blank"><img
                                                                style="width:120px;height:80px;object-fit: cover"
                                                                src="{{ asset('storage/app/public/faceId/' . $value['face_id_out']) }}"
