                                        ...
                                        <select class="form-control employee_id select2 required" required
                                            ...
                                            @foreach ($employeeList as $value)
                                                <option value="{{ $value->employee_id }}"
                                                    ...
                                                    {{ $value->first_name }} {{ $value->last_name }} ({{ $value->emp_code }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    @if (count($results) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif ($value['action'] == 'Leave')
                                                        ...
                                                        <?php $totalLeave += 1; ?>
                                                    @elseif ($value['action'] == 'OD')
                                                        <span class='label label-warning'> {{ __('common.od') }}
                                                        </span></p>
                                                        <?php $totalOD += 1; ?>
                                                    ...
                                                    @elseif($value['action'] == 'Present')
                                                        ...
                                                        <?php $totalPresent += 1; ?>
                                                    @elseif($value['action'] == 'Weekoff')
                                                        <span
                                                            class='label label-warning'>{{ 'Weekoff' }}</span>
                                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td style="background: #fff"><b>Total OD: &nbsp;</b></td>
                                            <td style="background: #fff"><b>{{ round($totalOD) }}</b>
                                                @lang('common.days')
                                            </td>
                                        </tr>
                                        <tr>
