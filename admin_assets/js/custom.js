...
class mylog {
    constructor(color='8b0000') {
      this.color = color;
    }

    log(msg) {
        console.log('%c' + ' ' + msg + ' ', 'background:#bfbbbb; color: #'+this.color);
    }
}

function slog(text) {
    let lg = new mylog('009900');
    lg.log(text);
    return void null;
}
function ilog(text) {
    let lg = new mylog('0000ff');
    lg.log(text);
    return void null;
}
function wlog(text) {
    let lg = new mylog('ff8100');
    lg.log(text);
    return void null;
}
function elog(text) {
    let lg = new mylog('ff0000');
    lg.log(text);
    return void null;
}