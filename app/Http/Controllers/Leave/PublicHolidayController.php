...
class PublicHolidayController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.leave.publicHoliday.form', ['holidayList' => $holidayList, 'leaveTimingList' => $leaveTimingList]);
    }
    ...
    public function store(PublicHolidayRequest $request)
    {
        ...
        $input['leave_timing']   = 1;
        try {
            HolidayDetails::createTrait($input);
            $bug = 0;
        } catch (\Exception $e) {
            $bug = 1;
        }
    ...
    public function edit($id)
    {
        ...
        return view('admin.leave.publicHoliday.form', ['editModeData' => $editModeData, 'holidayList' => $holidayList, 'leaveTimingList' => $leaveTimingList]);
    }
