...
class EmployeeDetailsExport implements WithHeadings, FromCollection, WithProperties, WithEvents, WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use (
                ...
                $PERMANENT_STATUS = ['Yes', 'No'];
                $EPF_STATUS = ['Yes', 'No'];
                $GENDER_DATA = ['Male', 'Female'];
                $STATUS_DATA = ['Active', 'Inactive'];
                $MARITAL_STATUS = ['Married', 'Unmarried'];
                $drop_column = [
                    ['cell' => 'O', 'options' => $GENDER_DATA],
                    ['cell' => 'Q', 'options' => $MARITAL_STATUS],
                    ['cell' => 'T', 'options' => $STATUS_DATA],
                    // ['cell' => 'AH', 'options' => $PERMANENT_STATUS],
                    // ['cell' => 'AI', 'options' => $EPF_STATUS],
                ];
    ...
    {
        return [
            'creator' => 'in4' . auth()->user()->user_name,
            'lastModifiedBy' => 'in4 ' . auth()->user()->user_name,
            'title' => 'EmployeeInfo',
            'description' => 'in4  - EmployeeInfo',
            'subject' => 'in4 - EmployeeInfo',
